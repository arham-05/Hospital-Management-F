...
export const appointmentPageStyles = {
  ...
  pageContainer: "min-h-screen font-serif bg-linear-to-br from-blue-50 to-emerald-100 py-10 px-4",
  maxWidthContainer: "max-w-6xl mx-auto",
  
  // Title styles
  doctorTitle: "text-3xl font-bold text-emerald-700 text-center mb-6",
  serviceTitle: "text-3xl font-bold text-green-700 text-center mb-6",
  
  // Loading and empty states
  loadingText: "text-center text-emerald-600 py-4",
  serviceLoadingText: "text-center text-green-600 py-4",
  emptyStateText: "text-center text-emerald-600 py-4",
  serviceEmptyStateText: "text-center text-green-600 py-4",
...
export const bannerStyles = {
  ...
  outerAnimatedBand: "absolute inset-0 rounded-3xl bg-linear-to-r from-blue-400 via-emerald-500 to-blue-400 animate-[spin_3s_linear_infinite] opacity-80",
  ...
  titleGradient: "text-transparent bg-linear-to-r from-blue-600 to-green-600 bg-clip-text",
  ...
  taglineHighlight: "text-blue-600 font-semibold",
  
  // Features grid
  featuresGrid: "grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6 text-sm sm:text-base",
  featureItem: "flex items-center justify-center lg:justify-start bg-linear-to-br from-blue-500 to-blue-200 backdrop-blur-sm p-3 rounded-full shadow-sm border",
  featureIcon: "w-5 h-5 text-black mr-3",
  featureText: "text-black-700 font-medium",
  ...
  bookButton: "group relative lg:whitespace-nowrap bg-linear-to-r from-blue-600 to-emerald-400 text-black  px-6 py-3 sm:px-8 sm:py-4 rounded-full font-bold transform transition-all duration-300 shadow-3xl hover:shadow-3xl overflow-hidden text-sm sm:text-base",
...
export const certificationStyles = {
  ...
  topLine: "absolute top-0 left-0 w-full h-1 bg-linear-to-br from-transparent via-blue-400 to-transparent opacity-60",
  gridContainer: "absolute inset-0 opacity-[0.02]",
  grid: "grid grid-cols-12 gap-4 w-full h-full",
  gridCell: "border border-blue-300 rounded",
  ...
  leftLine: "absolute -left-20 top-1/2 w-16 h-0.5 bg-linear-to-br from-transparent to-blue-400",
  rightLine: "absolute -right-20 top-1/2 w-16 h-0.5 bg-linear-to-br from-transparent to-teal-400",
  title: "text-3xl lg:text-6xl font-serif text-black-900 mb-4 tracking-tight",
  titleText: "bg-linear-to-br from-blue-600 via-teal-600 to-blue-600 bg-clip-text text-transparent",
  subtitle: "text-lg text-black-600 max-w-2xl mx-auto leading-relaxed font-light tracking-wide",
  badgeContainer: "inline-flex font-semibold items-center px-5 py-2.5 bg-blue-500/20 border border-blue-400/30 rounded-full mt-6 backdrop-blur-sm",
  badgeDot: "w-2.5 h-2.5 bg-green-500 rounded-full animate-pulse mr-3",
  badgeText: "text-black-700 font-semibold tracking-wide text-sm",
...
export const navbarStyles = {
  ...
  logoTitle: "text-2xl md:text-2xl lg:text-2xl xl:text-2xl font-bold bg-clip-text text-transparent bg-linear-to-r from-blue-600 to-green-600 tracking-tight",
  ...
  loginButton: "btn-login hidden lg:flex lg:text-sm items-center gap-2 bg-linear-to-r from-blue-500 to-green-400 text-black px-6 py-2.5 rounded-full font-bold hover:shadow-xl transition-all duration-300 cursor-default",
  loginIcon: "w-4 h-4",
  ...
  mobileLoginButton: "w-full cursor-default md:rounded-full flex items-center justify-center gap-2 bg-linear-to-r from-blue-500 to-green-400 text-black py-2.5 rounded-lg font-semibold hover:shadow-lg transition-all",
